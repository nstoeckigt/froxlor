...
'websrvuserdoesnotexist' => 'Given webserver-user does not seem to exist on the system',
			...
			'serversettings.service_ports_customer' => 'Customer Service Ports',
			'serversettings.service_ports_customer_desc' => 'Define which webserver and ports should serve customer websites. Format: service:port;service:port (e.g., apache:80;apache:443)',
