...
'websrvuserdoesnotexist' => 'Given webserver-user does not seem to exist on the system',
			...
			'admin.configfiles.http' => 'HTTP/Web',
			'admin.configfiles.panel_server' => 'Panel Server',
			'admin.configfiles.customer_web' => 'Customer Web',
			'service_ports_title' => 'Service Separation',
			'service_ports_panel' => 'Panel Service Ports',
			'service_ports_panel_desc' => 'Define which webserver and ports should serve the Froxlor panel. Format: service:port;service:port (e.g., nginx:8080;nginx:8043)',
			'service_ports_customer' => 'Customer Service Ports',
			'service_ports_customer_desc' => 'Define which webserver and ports should serve customer websites. Format: service:port;service:port (e.g., apache:80;apache:443)',
			'service_ports_enable' => 'Enable Service Separation',
			'service_ports_enable_desc' => 'When enabled, Froxlor generates configs only for the specified service/port combinations. This allows running multiple webservers (e.g., nginx for panel, apache for customers).',
			// Neue Keys für serversettings
			'serversettings.service_ports_enable' => 'Enable Service Separation',
			'serversettings.service_ports_enable_desc' => 'When enabled, Froxlor generates configs only for the specified service/port combinations. This allows running multiple webservers (e.g., nginx for panel, apache for customers).',
			'serversettings.service_ports_panel' => 'Panel Service Ports',
			'serversettings.service_ports_panel_desc' => 'Define which webserver and ports should serve the froxlor panel. Format: service:port;service:port (e.g., nginx:8080;nginx:8043)',
			'serversettings.panel_ports' => 'Panel Ports',
			'serversettings.panel_ports_desc' => 'Ports for the froxlor panel webserver (e.g., nginx:8080;nginx:8043)',
			'serversettings.panel_webserver' => 'Panel Webserver',
			'serversettings.panel_http_port' => 'Panel HTTP Port',
			'serversettings.panel_https_port' => 'Panel HTTPS Port',
			'serversettings.customer_webserver' => 'Customer Webserver',
			'serversettings.customer_http_port' => 'Customer HTTP Port',
			'serversettings.customer_https_port' => 'Customer HTTPS Port',
			'serversettings.customer_http_to_https_redirect' => 'HTTP to HTTPS Redirect',
			'serversettings.customer_http_to_https_redirect_desc' => 'Automatically redirect HTTP requests to HTTPS',
