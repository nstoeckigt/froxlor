...
Vielen Dank, Ihr Administrator',
	...
	'install' => [
		...
		'errors' => [
			...
			'admin.configfiles.customer_web' => 'Kunden Web',
			'service_ports_title' => 'Dienst-Trennung',
			'service_ports_title' => 'Dienst-Trennung',
			'service_ports_panel' => 'Panel-Dienst-Ports',
			'service_ports_panel_desc' => 'Definiert welcher Webserver und welche Ports das Froxlor-Panel bedienen sollen. Format: Dienst:Port;Dienst:Port (z.B. nginx:8080;nginx:8043)',
			'serversettings.panel_ports' => 'Panel-Ports',
'serversettings.panel_ports_desc' => 'Ports für den froxlor Panel Webserver (z.B. nginx:8080;nginx:8043)',
'serversettings.customer_ports' => 'Kunden-Ports',
'serversettings.customer_ports_desc' => 'Ports für Kunden-Websites (z.B. apache:80;apache:443)',
'serversettings.customer_webserver' => 'Kunden Webserver',
			'service_ports_customer' => 'Kunden-Dienst-Ports',
			'service_ports_customer_desc' => 'Definiert welcher Webserver und welche Ports die Kunden-Websites bedienen sollen. Format: Dienst:Port;Dienst:Port (z.B. apache:80;apache:443)',
			'service_ports_enable' => 'Dienst-Trennung aktivieren',
			'service_ports_enable_desc' => 'Wenn aktiviert, generiert Froxlor Configs nur für die angegebenen Dienst/Port-Kombinationen. Dies ermöglicht den Betrieb mehrerer Webserver (z.B. nginx für Panel, apache für Kunden).',
			'serversettings.service_ports_enable' => 'Dienst-Trennung aktivieren',
			'serversettings.service_ports_enable_desc' => 'Wenn aktiviert, generiert Froxlor Configs nur für die angegebenen Dienst/Port-Kombinationen. Dies ermöglicht den Betrieb mehrerer Webserver (z.B. nginx für Panel, apache für Kunden).',
			...
			'serversettings.customer_webserver' => 'Kunden Webserver',
			'serversettings.customer_http_port' => 'Kunden HTTP Port',
			'serversettings.customer_https_port' => 'Kunden HTTPS Port',
			'serversettings.customer_http_to_https_redirect' => 'HTTP zu HTTPS Weiterleitung',
			'serversettings.customer_http_to_https_redirect_desc' => 'HTTP Anfragen automatisch zu HTTPS weiterleiten',
